...
* save complete dataset ;
	gsort year_cal week_mmwr ;
	save "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all-cause analysis - sample data - v6 .dta", replace ;
log close ;
end ;
