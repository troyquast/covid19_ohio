...
log using "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by gender analysis - 01 - create sample data - v6 .smcl", replace ;
...
* save complete dataset ;
	gsort year_cal week_mmwr gender ;
	save "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by gender analysis - sample data - v6 .dta", replace ;
log close ;
end ;
