...
#delimit ;
log using "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by gender analysis - 02 - estimation - v7 .smcl", replace ;

* open sample data ;
	use "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by gender analysis - sample data - v6 .dta", clear ;
...
* merge w/ full dataset ;
	merge 1:1 year_cal week_mmwr gender using "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by gender analysis - sample data - v6 .dta" ;
* prep & save data ;
	...
	* save data ;
		save "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\counter mort datasets\covid-19 ohio state all causes by gender analysis - actual & counter counts - v7 .dta", replace ;
log close ;
end ;