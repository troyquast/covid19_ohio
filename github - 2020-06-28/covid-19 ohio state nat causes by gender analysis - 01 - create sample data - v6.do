...
log using "covid-19 ohio state nat causes by gender analysis - 01 - create sample data - v6 .smcl", replace ;
* read in, revise, & save datasets ;
	* deaths data ;
		* read in data ;
			import excel 
				"ohio deaths by county, year, & mmwr week (2010-2020) - v3 .xlsx" , 
				sheet("dths- st nat gender") firstrow allstring ;
		* drop total row ;
...
* save complete dataset ;
	gsort year_cal week_mmwr gender ;
	save "covid-19 ohio state nat causes by gender analysis - sample data - v6 .dta", replace ;
log close ;
end ;
