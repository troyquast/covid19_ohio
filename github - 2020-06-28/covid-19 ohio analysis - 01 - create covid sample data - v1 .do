...
log using "covid-19 ohio analysis - 01 - create covid sample data - v1 .smcl", replace ;
* read in dataset & prep to create vars ;
	* read in dataset ;
		import delimited 
			"ohio disease report sys - covid-19 summary data - downloaded 2020-06-15 .csv" , 
...
* save final dataset ;
	...
	save "covid-19 ohio analysis - covid sample data - v1 .dta", replace ;
log close ;
end ;
