...
log using "covid-19 ohio state nat causes by race analysis - 01 - create sample data - v6 .smcl", replace ;
* read in, revise, & save datasets ;
	* deaths data ;
		* read in data ;
			import excel 
				"ohio deaths by county, year, & mmwr week (2010-2020) - v3 .xlsx" , 
				sheet("dths- st nat race") firstrow allstring ;
		* drop total row ;
...
* save complete dataset ;
	gsort year_cal week_mmwr race ;
	save "covid-19 ohio state nat causes by race analysis - sample data - v6 .dta", replace ;
log close ;
end ;
