...
#delimit ;
log using "covid-19 ohio state all-cause analysis - 02 - estimation - v7 .smcl", replace ;

* open sample data & save as temp dataset ;
	use "covid-19 ohio state all-cause analysis - sample data - v6 .dta", clear ;
...
*/
		...
		* merge w/ full dataset ;
			merge 1:1 year_cal week_mmwr using "covid-19 ohio state all-cause analysis - sample data - v6 .dta" ;
* prep & save data ;
	...
	* save data ;
		save "covid-19 ohio state all-cause analysis - actual & counter counts - v7 .dta", replace ;
log close ;
end ;