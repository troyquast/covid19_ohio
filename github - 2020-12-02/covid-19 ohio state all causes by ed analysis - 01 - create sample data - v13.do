...
log using "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by ed analysis - 01 - create sample data - v13 .smcl", replace ;
...
* save complete dataset ;
	gsort year_cal week_mmwr ed_attain ;
	save "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all causes by ed analysis - sample data - v13 .dta", replace ;
log close ;
end ;
