...
log using "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio county all causes analysis - 01 - create sample data - v13 .smcl", replace ;
	...
	* deaths data ;
		* read in data ;
			import excel 
				...
				sheet("dths- cty all") firstrow allstring ;
		* drop total row ;
...
* save complete dataset ;
	...
	save "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio county all causes analysis - sample data - v13 .dta", replace ;
log close ;
end ;
