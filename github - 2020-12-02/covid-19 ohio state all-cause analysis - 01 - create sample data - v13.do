...
log using "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all-cause analysis - 01 - create sample data - v13 .smcl", replace ;
...
* revise & create vars ;
	...
	* (don't needed dummy for 2020 since it is not included in the baseline period) ;
		* dummy vars ;
...
* save complete dataset ;
	gsort year_cal week_mmwr ;
	save "C:\Users\Troy\Box Sync\_ troy's files\research\covid-19\2020-05 - ohio analysis\stata work\covid-19 ohio state all-cause analysis - sample data - v13 .dta", replace ;
log close ;
end ;
